...
import { ProductExportReceiptResponse, ProductImportReceiptResponse, ProductVariantResponse } from "@/types/ProductType";
...
export const productVariantApi = {
    ...
    uploadImage: (id: string, data: FormData, config: any) => post(`${productVariantPath}/${id}/image`, data, undefined, config), 
    getOneProductImportReceipt: (id: string, queryString: string) => get(`${productVariantPath}/${id}/import-receipt/${queryString}`),
    getOneProductExportReceipt: (id: string, queryString: string) => get(`${productVariantPath}/${id}/export-receipt/${queryString}`),
...
export const getAllProductVariantFn = async ({
  ...
  export const getOneProductImportReceiptFn = async (id:string,{
    sorting,
    columnFilters,
    pagination,
  }: InputType): Promise<ProductImportReceiptResponse> => {
    const limit = pagination.pageSize;
    const offset = pagination.pageIndex * pagination.pageSize;
  ...
  export const getOneProductExportReceiptFn = async (id:string,{
    sorting,
    columnFilters,
    pagination,
  }: InputType): Promise<ProductExportReceiptResponse> => {
    const limit = pagination.pageSize;
    const offset = pagination.pageIndex * pagination.pageSize;
