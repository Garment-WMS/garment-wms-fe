...
import { TimePickerInput } from "@/components/common/DayTimePicker/time-picker-input";
...
function DatetimePicker({
  ...
  const { selected: selectedDate = new Date() } = props as { selected: Date | undefined };

  const setDate = (dateInput: Date) => {
    if (!selectedDate) return;  // Exit if no date is set
...
export { DatetimePicker as DatetimePickerForImportRequest };