...
const ProductionPlanIntroduction = () => {
  ...
  return (
    <div className="w-full h-28 bg-white rounded-xl shadow-sm border md:h-48">
      <div className="flex items-center w-full h-full justify-between">
        <div className="flex flex-col justify-center h-full md:pl-6 lg:pl-12 w-full max-w-4xl">
          {' '}
          {/* Added max-width */}
          <h1 className="font-primary font-bold text-bluePrimary text-xl pt-4 pl-4 md:text-2xl lg:text-3xl xl:text-4xl">
            {title}
          </h1>
          <p className="text-xs font-primary font-semibold text-slate-400 pl-4 md:text-md lg:text-lg whitespace-nowrap overflow-hidden text-ellipsis">
            {description}
          </p>
        </div>
