import photo from '@/assets/images/warehouseStaff.svg';
const WarehouseStaffIntroduction = () => {
  const title = 'Warehouse Staff';
  const description = ' Oversees warehouse staff operations and assignments.';
  return (
    <div
...
export default WarehouseStaffIntroduction;
