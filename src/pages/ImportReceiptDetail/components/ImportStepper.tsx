...
type Step = 'AWAIT_TO_IMPORT' | 'IMPORTING' | 'IMPORTED';
...
const steps: { title: Step; icon: React.ElementType; displayName: any }[] = [
  { title: 'AWAIT_TO_IMPORT', icon: Clock, displayName: 'Await to import' },
  { title: 'IMPORTING', icon: ArrowDownCircle, displayName: 'Importing' },
  { title: 'IMPORTED', icon: CheckCircle, displayName: 'Imported' }
];
